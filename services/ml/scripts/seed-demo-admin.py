...
def main():
    ...
    # Write both service-specific and repository-level .env so the service
    ...
    print(f"Writing env file to {env_path} and {repo_env_path}")
    write_env_file(env_path, values)
    write_env_file(repo_env_path, values)
